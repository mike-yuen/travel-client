...
export default {
        ...
        if (this.piecewise) {
          piecewiseDot.push(
            h("span", {
              ...
              style: [
                this.piecewiseStyle,
                item.inRange ? this.piecewiseActiveStyle : null
              ]
            })
          );
        }
          ...
          piecewiseLabel.push(
            h(
              "span",
              {
                ...
                style: [
                  this.labelStyle,
                  item.inRange ? this.labelActiveStyle : null
                ]
              },
              item.label
            )
                ...
                h(
                  ...
                  this.mergeFormatter
                    ...
                    ? this.val[0] === this.val[1]
                      ...
                      : `${this.formatting(this.val[0])} - ${this.formatting(
                          this.val[1]
                        )}`
                    : this.val[0] === this.val[1]
                    ? this.val[0]
    ...
    tooltipMergedPosition() {
      ...
      if (dot0) {
        ...
        if (this.direction === "vertical") {
          style[tooltipDirection] = `-${this.dotHeightVal / 2 -
            this.width / 2 +
            9}px`;
        } else {
          style[tooltipDirection] = `-${this.dotWidthVal / 2 -
            this.height / 2 +
            9}px`;
          style["left"] = `50%`;
        }
  ...
  methods: {
    ...
    handleDisplayMergedTooltip(show) {
      ...
      const mergedTooltip = this.$refs.process.getElementsByClassName(
        "merged-tooltip"
      )[0];
      if (show) {
